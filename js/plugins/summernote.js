...
(function (factory) {
  ...
  var Editor = function (context) {
     ...
     * @param {File[]} files
     */
    this.FileCallback = function (files) {
      var callbacks = options.callbacks;

      // If onImageUpload options setted
      if (callbacks.onFileUpload) {
        context.triggerEvent('file.upload', files);
      // else insert Image as dataURL
      }
    };
  ...
  var Buttons = function (context) {
    ...
    this.addToolbarButtons = function () {
      ...
      context.memo('button.file_upload', function () {
        return ui.button({
          contents: ui.icon(options.icons.file_upload),
          tooltip: lang.file.file,
          click: context.createInvokeHandler('FileUploadDialog.show')
        }).render();
      });
  ...
  var ImageDialog = function (context) {
    ...
    this.initialize = function () {
      ...
      var body = '<div class="form-group note-group-select-from-files">' +
                   '<label>' + lang.image.selectFromFiles + upload_message_fallback() + '</label>' +
  ...
  var FileUploadDialog = function (context) {
    var self = this;
    var ui = $.summernote.ui;
    ...
    this.initialize = function () {
      ...
      var body = '<div class="form-group note-group-select-from-files">' +
                   '<label>' + lang.file.selectFromFiles + upload_message_fallback() + '</label>' +
                   '<input class="note-image-input form-control" type="file" name="files" multiple="multiple" />' +
                   imageLimitation +
                 '</div>';
    ...
    this.show = function () {
      ...
      this.showImageDialog().then(function (data) {
        ...
        if (typeof data === 'string') { // image url
          ...
          context.invoke('editor.FileCallback', data);
        }
      }).fail(function () {
        context.invoke('editor.restoreRange');
      });
  ...
  $.extend($.summernote.lang, {
    'es-ES': {
      ...
      file: {
        ...
        insert: 'Insertar archivos adjuntos',
        selectFromFiles: 'Seleccionar desde los archivos'
      },
      video: {
        video: 'Vídeo',
